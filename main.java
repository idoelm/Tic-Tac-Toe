...
public class main 
{
	...
	public static void main(String[] args) throws IOException, InterruptedException 
	{
		...
		String[] str = {"Pokémon Season 12.wav", "Pokemon 4ever.wav", "Pokémon.wav", "Pokémon10.wav", "PokémonXYZ.wav"};
		int x = (int)(Math.random() * (str.length - 0) + 0);
		MusicPlayer player1 = new MusicPlayer(str[x]);
		player1.start();
